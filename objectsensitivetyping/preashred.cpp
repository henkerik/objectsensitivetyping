...
//            return in;
        	...
        	if (!in->variable->is_simple_variable ())
        	{
                ...
                Variable* cloned = lhs->clone ();
        		cloned->attrs->set_true ("phc.ast_shredder.dont_shred");
                cloned->attrs->set_true ("uu.ast_shredder.dont_shred");
